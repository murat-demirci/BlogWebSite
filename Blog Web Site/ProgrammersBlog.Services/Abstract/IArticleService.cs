...
namespace ProgrammersBlog.Services.Abstract
{
    public interface IArticleService
    {
        ...
        Task<IDataResult<ArticleDto>> GetIdAsync(int articleId,bool includeCategory,bool includeComments,bool includeUser);
        ...
        Task<IDataResult<ArticleListDto>> GetAllByPagingAsync(int? categoryId,int currentPage=1,int pageSize=6,bool isAscending=false);
        Task<IDataResult<ArticleListDto>> GetAllByUserIdOnFilter(int userId, FilterBy filterBy, OrderBy orderBy,bool isAscending,int takeSize,
            int categoryId,DateTime starAt,DateTime endAt,int minViewCount, 
