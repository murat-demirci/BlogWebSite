...
namespace ProgrammersBlog.Services.Abstract
{
    public interface ICategoryService
    {
        ...
        /// <returns>Asenkron bir operasyon ile Task olarak islem sonucunu DataResult tipinde geri döner</returns>
        ...
        /// /// <param name="createdByName">string tipinde, kullanici adi</param>
        /// <returns>Asenkron bir operasyon ile Task olarak ekleme isleminin sonucunu DataResult tipinde geri döner</returns>
