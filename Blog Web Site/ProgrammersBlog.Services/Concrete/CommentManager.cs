...
namespace ProgrammersBlog.Services.Concrete
{
    public class CommentManager : ManagerBase, ICommentService
    {
        ...
        public async Task<IDataResult<CommentDto>> GetAsync(int commentId)
        {
            ...
            return new DataResult<CommentDto>(ResultStatus.Error, Message.Comment.NotFound(isPlural: false), new CommentDto
            {
                Comment = null,
            });
        }
        ...
        public async Task<IDataResult<CommentUpdateDto>> GetCommentUpdateDtoAsync(int commentId)
        {
            ...
            {
                return new DataResult<CommentUpdateDto>(ResultStatus.Error, Message.Comment.NotFound(isPlural: false), null);
            }
        }
        ...
        public async Task<IDataResult<CommentListDto>> GetAllAsync()
        {
            ...
            return new DataResult<CommentListDto>(ResultStatus.Error, Message.Comment.NotFound(isPlural: true), new CommentListDto
            {
                Comments = null,
            });
        }
        ...
        public async Task<IDataResult<CommentDto>> ApproveAsync(int commentId, string modifiedByName)
        {
            ...
            if (comment!=null)
            {
                ...
                return new DataResult<CommentDto>(ResultStatus.Success, Message.Comment.Approve(commentId), new CommentDto
                {
                    Comment = updatedComment
                });
            }

            return new DataResult<CommentDto>(ResultStatus.Error, Message.Comment.NotFound(isPlural: false),null);
        }
        ...
        public async Task<IDataResult<CommentDto>> AddAsync(CommentAddDto commentAddDto)
        {
            ...
            if (article == null)
            {
                return new DataResult<CommentDto>(ResultStatus.Error, Message.Article.NotFound(isPlural: false), null);
            }
            ...
            await UnitOfWork.Articles.UpdateAsync(article);
            await UnitOfWork.SaveAsync();
            return new DataResult<CommentDto>(ResultStatus.Success, Message.Comment.Add(commentAddDto.CreatedByName), new CommentDto
            {
        ...
        public async Task<IDataResult<CommentDto>> UpdateAsync(CommentUpdateDto commentUpdateDto, string modifiedByName)
        {
            ...
            await UnitOfWork.SaveAsync();
            return new DataResult<CommentDto>(ResultStatus.Success, Message.Comment.Update(comment.CreatedByName), new CommentDto
            {
                Comment = updatedComment,
            });
        }
        ...
        public async Task<IDataResult<CommentDto>> DeleteAsync(int commentId, string modifiedByName)
        {
            ...
            if (comment != null)
            {
                ...
                await UnitOfWork.Articles.UpdateAsync(article);
                await UnitOfWork.SaveAsync();
                return new DataResult<CommentDto>(ResultStatus.Success, Message.Comment.Delete(deletedComment.CreatedByName), new CommentDto
                {
        ...
        public async Task<IResult> HardDeleteAsync(int commentId)
        {
            ...
            if (comment != null)
            {
                if (comment.IsDeleted)
                {
                    ...
                    await UnitOfWork.SaveAsync();
                    return new Result(ResultStatus.Success, Message.Comment.HardDelete(comment.CreatedByName));
                }
                var article = comment.Article;
                await UnitOfWork.Comments.DeleteAsync(comment);
                article.CommentCount =
            ...
            return new Result(ResultStatus.Error, Message.Comment.NotFound(isPlural: false));
        }
        ...
        public async Task<IDataResult<CommentDto>> UndoDeleteAsync(int commentId, string modifiedByName)
        {
            ...
            if (comment != null)
            {
                ...
                article.CommentCount += 1;
                    await UnitOfWork.Articles.UpdateAsync(article);
                await UnitOfWork.SaveAsync();
                return new DataResult<CommentDto>(ResultStatus.Success, Message.Comment.UndoDelete(deletedComment.CreatedByName), new CommentDto
                {
                    Comment = deletedComment,
                });
            }
