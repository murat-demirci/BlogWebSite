...
namespace ProgrammersBlog.Services.Concrete
{
    public class CategoryManager: ManagerBase,ICategoryService
    {
        ...
        public async Task<IDataResult<CategoryDto>> GetAsync(int categoryId)
        {
           ...
           return new DataResult<CategoryDto>(ResultStatus.Error,Message.Category.NotFound(isPlural:false),new CategoryDto
           {
               Category = null,
               ResultStatus = ResultStatus.Error,
               Message = Message.Category.NotFound(isPlural: false)
           });
        }
        ...
        public async Task<IDataResult<CategoryUpdateDto>> GetCategoryUpdateDtoAsync(int categoryId)
        {
            ...
            {
                return new DataResult<CategoryUpdateDto>(ResultStatus.Error,Message.Category.NotFound(isPlural:false),null);
            }
        }
        ...
        public async Task<IDataResult<CategoryListDto>> GetAllAsync()
        {
            ...
            return new DataResult<CategoryListDto>(ResultStatus.Error,Message.Category.NotFound(isPlural:true),new CategoryListDto
            {
                Categories = null,
                ResultStatus = ResultStatus.Error,
                Message = Message.Category.NotFound(isPlural: true)
            });
        }
        ...
        public async Task<IDataResult<CategoryListDto>> GetAllByNonDeletedAndActiveAsync()
        {
            ...
            return new DataResult<CategoryListDto>(ResultStatus.Error, Message.Category.NotFound(isPlural: true), null);
        }
        ...
        public async Task<IDataResult<CategoryDto>> AddAsync(CategoryAddDto categoryAddDto, string createdByName)
        {
            ...
            return new DataResult<CategoryDto>(ResultStatus.Success,Message.Category.Add(addedCategory.Name),new CategoryDto
            {
                Category = addedCategory,
                ResultStatus = ResultStatus.Success,
                Message = Message.Category.Add(addedCategory.Name)
            });
        }
        ...
        public async Task<IDataResult<CategoryDto>> UpdateAsync(CategoryUpdateDto categoryUpdateDto, string modifiedByName)
        {
           ...
           var updatedCategory = await UnitOfWork.Categories.UpdateAsync(category);
            await UnitOfWork.SaveAsync();
            return new DataResult<CategoryDto>(ResultStatus.Success, Message.Category.Update(updatedCategory.Name),new CategoryDto
            {
                Category = updatedCategory,
                ResultStatus = ResultStatus.Success,
                Message = Message.Category.Update(updatedCategory.Name)
            });
        }
        ...
        public async Task<IDataResult<CategoryDto>> DeleteAsync(int categoryId, string modifiedByName)
        {
            ...
            if (category!=null)
            {
                ...
                await UnitOfWork.SaveAsync();
                return new DataResult<CategoryDto>(ResultStatus.Success, Message.Category.Delete(deletedCategory.Name), new CategoryDto
                {
                    Category = deletedCategory,
                    ResultStatus = ResultStatus.Success,
                    Message = Message.Category.Delete(deletedCategory.Name)
                });
            }
            return new DataResult<CategoryDto>(ResultStatus.Error, Message.Category.NotFound(isPlural: false), new CategoryDto
            {
        ...
        public async Task<IDataResult<CategoryDto>> UndoDeleteAsync(int categoryId, string modifiedByName)
        {
            ...
            if (category != null)
            {
                ...
                var deletedCategory = await UnitOfWork.Categories.UpdateAsync(category);
                await UnitOfWork.SaveAsync();
                return new DataResult<CategoryDto>(ResultStatus.Success, Message.Category.UndoDelete(deletedCategory.Name), new CategoryDto
                {
                    Category = deletedCategory,
                    ResultStatus = ResultStatus.Success,
                    Message = Message.Category.UndoDelete(deletedCategory.Name)
                });
            }
            return new DataResult<CategoryDto>(ResultStatus.Error, Message.Category.NotFound(isPlural: false), new CategoryDto
            {
        ...
        public async Task<IResult> HardDeleteAsync(int categoryId)
        {
            ...
            if (category != null)
            {
                ...
                await UnitOfWork.SaveAsync();
                return new Result(ResultStatus.Success, Message.Category.HardDelete(category.Name));
            }
            return new Result(ResultStatus.Error, Message.Category.NotFound(isPlural:false));
        }
