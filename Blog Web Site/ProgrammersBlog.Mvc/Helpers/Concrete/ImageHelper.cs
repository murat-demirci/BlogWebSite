...
namespace ProgrammersBlog.Mvc.Helpers.Concrete
{
    public class ImageHelper : IImageHelper
    {
        ...
        public IDataResult<ImageDeletedDto> Delete(string pictureName)
        {
            ...
            {
                return new DataResult<ImageDeletedDto>(ResultStatus.Error,$"Böyle bir resim bulunamadi",null);
            }
        }

        public async Task<IDataResult<ImageUploadedDto>> Uploaded(string name, IFormFile pictureFile, PictureType pictureType, string folderName = null)
        {
